      ...
      <a href="#">
        ...
        <div class="px-4 py-3 w-full">
          ...
          <div class="flex items-center">
            ...
            <button onClick={() => { purchaseHandler(product) }} class="ml-auto duration-500 hover:scale-110"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
              fill="currentColor" class="fill-blue-900 h-[2em] w-full hover:fill-red-900" viewBox="0 0 16 16">
