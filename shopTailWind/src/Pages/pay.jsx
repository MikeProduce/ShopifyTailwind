...
export const FetchDataComponent = (props) => {
...
function OtherComponent(props) {
  return (
    <div>
      <FetchDataComponent onDataFetched={props.onDataFetched} />
      {/* ... */}
    </div>
  );
}
...
function App() {
  ...
  return (
    <div>
      <OtherComponent onDataFetched={handleDataFetched} />
      <div>{cartData.map(item => <p>{item.name}</p>)}</div>
    </div>
  );
}
...
/// idea for rendering the props to another location 